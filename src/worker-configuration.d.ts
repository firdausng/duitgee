/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: c93bd32e5334791576e3e78488ad4f2f)
// Runtime types generated with workerd@1.20251011.0 2025-11-01 nodejs_als
declare namespace Cloudflare {
	// `GlobalProps.mainModule: typeof import("../.svelte-kit/cloudflare/_worker")`
	// was previously generated here, but it pulled the compiled build output
	// into svelte-check and produced 12k+ false errors. Wrangler added it in
	// recent versions; we strip it after every `pnpm run cf-typegen` run.
	interface Env {
		KV: KVNamespace;
		CALLBACK_PATH: "/vaults";
		ENVIRONMENT: "development" | "staging" | "production";
		EMAIL_FROM: "support@mail.duitgee.com";
		VAULT_LIMIT: 1;
		CRON_SECRET: "duitgee@svelte@d2d2c215-a912-4812-bae6-18e739133cff";
