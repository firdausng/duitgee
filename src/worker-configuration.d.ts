/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 2cd7cf72cf931f22593542d8815c6f5d)
...
declare namespace Cloudflare {
	...
	// into svelte-check and produced 12k+ false errors. Wrangler adds it in
	// recent versions; strip it after every `pnpm run cf-typegen` run.
	interface Env {
		KV: KVNamespace;
