...
import { processDueRecurringIncome } from '$lib/server/api/recurring-income/processDueRecurringIncome';
...
export const POST: RequestHandler = async ({ request, platform }) => {
    ...
    const result = await processDueRecurringIncome(platform.env, {
        now,
