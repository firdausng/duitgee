                                ...
                                >
                                    <RadioGroup.Item value="subscription" variant="card">
                                        {#snippet children()}
                                            ...
                                            <span class="mt-0.5 block text-xs text-muted-foreground">Ongoing, no end.</span>
                                        {/snippet}
                                    </RadioGroup.Item>
                                    <RadioGroup.Item value="installment" variant="card">
                                        {#snippet children()}
                                            <span class="block text-sm font-medium">Installment</span>
                                            <span class="mt-0.5 block text-xs text-muted-foreground">Finite — set a duration.</span>
                                        {/snippet}
                                    </RadioGroup.Item>
                                </RadioGroup.Root>
                            </div>
